...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $con->prepare('INSERT INTO professor (CPF_PROFESSOR, NOME, TELEFONE, DATA_NASC, CIDADE, BAIRRO, ENDERECO, ID_USER) 
    ...
    <form action="createProfessor.php" method="post">
        <div class="form-container">
            <div class="form-row">
                ...
                <div>
                    <h3>CPF:</h3>
                    <input type="text" name="CPF_PROFESSOR" placeholder="Digite o CPF" required>
                </div>
                <div>
